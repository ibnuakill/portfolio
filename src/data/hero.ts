  ...
  meta: [
    {
      ...
      subtitle: "Terbuka untuk kerja remote",
    },
    {
      icon: "cpu",
      title: "Frontend + Backend",
      subtitle: "Astro, React, Node.js",
    },
    {
      icon: "check",
      title: "Tersedia untuk project",
      subtitle: "Bisa mulai kapan saja",
    },
  ],
  stats: [
    { value: "15+", label: "Project selesai" },
